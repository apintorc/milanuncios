...
public class AnuncioService implements IAnuncioService {
    ...
    public AnuncioDto getAnuncioById(int id_anuncio) {
        ...
        if (anuncio != null) {
            ...
            anunciodto.setCategoria(categoriadtoCategoriaDto);
    ...
    public List<AnuncioDto> getAnunciosByUser(String user) {
        List<Anuncio> anuncios = anuncioRepository.findAnunciosByUser(user);
        List<AnuncioDto> anunciosdto = new ArrayList<>();
    ...
    public void updateAnuncioById(AnuncioDto anunciodto) {
        ...
        CategoriaDto categoriadtoCategoriaDto = anunciodto.getCategoria();
